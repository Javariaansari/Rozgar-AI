...
export default async function handler(req, res) {
  ...
  let query = admin
    .from('disputes')
    .select(
      '*, job:jobs!disputes_job_id_fkey(id, title, status), raiser:profiles!disputes_raised_by_fkey(id, name, email, role), against:profiles!disputes_against_user_id_fkey(id, name, email, role)',
      { count: 'exact' }
    )
